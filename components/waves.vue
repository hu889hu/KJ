<template>
  <div ref="chartRef" class="water-wave-chart"></div>
</template>
...
// 监听数据变化
watch(() => [props.value, props.label, props.colors], () => {
  if (chartInstance) {
    chartInstance.setOption({
      series: [{
        data: [props.value, props.value],
        label: { formatter: () => props.label },
        color: props.colors
      }]
    });
  }
